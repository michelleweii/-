...
#词汇表中的单词在输入文档中是否出现,函数返回的是某一文档向量——词集模型
...
#朴素贝叶斯分类器训练函数
#函数返回：正常文档概率总向量，垃圾文档概率总向量，垃圾文档概率
def trainNB0(trainMatrix, trainCategory):
    numTrainDocs = len(trainMatrix)
    numWords = len(trainMatrix[0])
    pAbusive = sum(trainCategory) / float(numTrainDocs)
    # p0Num = zeros(numWords); #case 1
    # p1Num = zeros(numWords)
    p0Num = ones(numWords); #case 2
    ...
    # p1Vect = p1Num / p1Denom  # case1
    # p0Vect = p0Num / p0Denom  # case1
    return p0Vect, p1Vect, pAbusive

#朴素贝叶斯分类函数
#vec2Classify要分类的向量,返回大概率对应的类别标签
